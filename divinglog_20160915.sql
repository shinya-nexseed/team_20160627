...
--
-- Host: localhost
-- Generation Time: 2016 年 9 月 15 日 09:12
...
CREATE TABLE `favorites` (
  `favorite_log_id` int(11) NOT NULL,
  `favoriter_id` int(11) NOT NULL
...
INSERT INTO `favorites` (`favorite_log_id`, `favoriter_id`) VALUES
(19, 10),
(18, 10),
(18, 15);
...
INSERT INTO `following` (`follow_id`, `follower_id`) VALUES
(11, 10),
(12, 10),
(10, 15);
...
(25, 'hoge', -1000, '35.609301599299535', '139.8683162128906', -1000, -1000, -1000, 'hoge', 'hoge', 'sample.jpg', -1000, -1000, 10, '2016-09-14 15:29:37', '2016-09-14 07:29:37');
